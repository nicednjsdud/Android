...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 그림을 클릭할때마다 투표수를 저장할 9개짜리 배열 선언, 0으로 초기화
        ...
        // <투표 종료> 클릭 이벤트 리스너 생성
        // 인텐트 생성, 인텐트에 투표수 배열과 그림 이름 배열 put한 후 두번째 액티비티 호출
